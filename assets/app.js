...
async function init() {
  try {
    const module = await import(new URL("content.mjs?v=20260722-research-agenda-v1", APP_ASSET_BASE).href);
...
const iaStylesheet = new URL("ia-style.css?v=20260722-ia-v12", APP_ASSET_BASE).href;
const iaRuntime = new URL("ia-runtime.js?v=20260722-ia-v12", APP_ASSET_BASE).href;
